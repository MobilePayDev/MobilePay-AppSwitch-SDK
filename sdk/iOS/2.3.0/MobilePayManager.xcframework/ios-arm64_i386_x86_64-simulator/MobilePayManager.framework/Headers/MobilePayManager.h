...
//! Project version number for MobilePayManager.
FOUNDATION_EXPORT double MobilePayManagerVersionNumber;

//! Project version string for MobilePayManager.
FOUNDATION_EXPORT const unsigned char MobilePayManagerVersionString[];

#ifndef MobilePayManager_h
#define MobilePayManager_h

#import <UIKit/UIKit.h>
#import <CoreGraphics/CoreGraphics.h>
#import <CoreImage/CoreImage.h>

#import <MobilePayManager/MobilePayPayment.h>
#import <MobilePayManager/MobilePaySuccessfulPayment.h>
#import <MobilePayManager/MobilePayErrorPayment.h>
#import <MobilePayManager/MobilePayCancelledPayment.h>
 ...
 * @param merchantUrlScheme urlscheme for your app setup under UrlIdentifier in your info.plist (this needs to be done to enable app switching in general)
 ...
 * @param merchantUrlScheme urlscheme for your app setup under UrlIdentifier in your info.plist (this needs to be done to enable app switching in general)
 * @param timeoutSeconds seconds that you allow the user to spend in the MobilePay app before returning to the merchant app, if exceeded when you try to swipe in Mobile Pay errorcode 8 is returned. Default is 0 = never timeout
 * @param captureType Determines if the payment is a reservation or instant capture - default is Yes for instant capture
 * @param country The country / version of MobilePay you wish your app to work with - Denmark (DK - mobilepay:// - which also is the default), Finland (FI - mobilepayfi://)
 */
